...
function updateSubjects() {
    const subjects = [
        { id: 'art', data: '2025. 4. 4 (4교시)', name: '미술', details: ['자신의 진로와 관련된 책 속 한 문장을 일러스트와 어울리게 자신의 서체로 표현한다.', '*문장을 암기하여 실시한다.(문장 또는 책 수정 시 반드시 리로스쿨 수정)'] },
        { id: 'art', data: '2025. 4. 11 (4교시)', name: '미술', details: ['자신의 진로와 관련된 책 속 한 문장을 일러스트와 어울리게 자신의 서체로 표현한다.', '*문장을 암기하여 실시한다.(문장 또는 책 수정 시 반드시 리로스쿨 수정)'] },
